...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // color of label showing current value
    valueFontSize: kvLookup('valueFontSize', config, dataset, 15),


    // Fix y position
    valueY: kvLookup('valueY', config, dataset, 100),
  ...
  if (obj.config.donut === true) {
    ...
    // value
    valueFontSize = (obj.config.valueFontSize > 0) ? obj.config.valueFontSize : ((widgetH / 6.4) > 16) ? (widgetH / 5.4) : 18;
    valueX = dx + widgetW / 2;
    ...
    // value y
    //valueY = (obj.config.valueY > 0) ? obj.config.valueY : widgetH / 1.275;
    ...
    valueYOld = dy + widgetH / 1.275;
    valueY = dy + obj.config.valueY;

    // label
    labelFontSize = ((widgetH / 16) > obj.config.labelMinFontSize) ? (widgetH / 16) : obj.config.labelMinFontSize;
    labelX = dx + widgetW / 2;
    //labelY = valueY + valueFontSize / 2 + 5;
    labelY = valueYOld + valueFontSize / 2 + 5;
